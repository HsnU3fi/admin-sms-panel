  ...
  <section>
    <client-only>
      <section class="animate__animated animate__fadeInUp">
        <Table ref="multipleTableRef" class="mt-4" :data="tableData">
            ...
            <el-table-column property="orderId" label="Order Id">
              <template #default="scope">
                <section class="flex items-center gap-2 justify-center">
                  <section
                    class="w-12 h-12 rounded-full flex items-center justify-center bg-Gray-b8"
                  >
                    <i class="isax isax-tick-circle text-xl" />
                  </section>
                  <section>
                    <h2 class="text-sm text-Gray-b6 font-normal">Orders ID</h2>
                    <p class="font-bold text-base text-Gray-b2">
                      #{{ scope.row.orderId }}
                    </p>
                  </section>
                </section>
            ...
            <el-table-column property="status" label="Status">
              <template #default="scope">
                <span
                  ...
                  class="block px-3 py-2 text-sm text-white rounded-xl max-w-fit m-auto"
